...
import 'package:ticket_booking/widget/app_text_widget.dart';
import 'package:ticket_booking/widget/ticket_tabs.dart';
        ...
        children: [
          ...
          Container(
            padding: EdgeInsets.symmetric(
                ...
                horizontal: AppLayout.getWidht(18)),
          ...
          Row(
            ...
            children: [
              Container(
                ...
                height: AppLayout.getHeight(429),
